...
public class ReleaseActivity extends AppCompatActivity {
    ...
    public class RunAPI extends AsyncTask<String, Object, List<ListItem>> {
        @Override
